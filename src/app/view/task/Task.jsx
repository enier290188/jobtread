...
const Layout = () => {
    return (
        <Box component={'div'}>
            <Typography component={'p'} variant={'body1'}>---Layout Main Task---</Typography>
            <Box component={'div'} display={'flex'}>
                <Box component={'div'} p={1}>
                    <LinkCustom to={`${SettingRoute.app.task.content001.TO}`}>Content001</LinkCustom>
                </Box>
                <Box component={'div'} p={1}>
                    <LinkCustom to={`${SettingRoute.app.task.content002.TO}`}>Content002</LinkCustom>
                </Box>
                <Box component={'div'} p={1}>
                    <LinkCustom to={`${SettingRoute.app.task.content003.TO}`}>Content003</LinkCustom>
                </Box>
            </Box>
    ...
    return (
        <Routes>
            <Route path={``} element={<Layout/>}>
                <Route index element={<Navigate to={`${SettingRoute.app.task.content002.TO}`}/>}/>
